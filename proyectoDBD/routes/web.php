...
Route::get('/puestosFerias/create','PuestoFeriaController@store');
...
Route::get('/puestosFerias/update/{id}','PuestoFeriaController@update');
...
Route::get('/puestosFerias/delete/{id}','PuestoFeriaController@destroy');
