    ...
    <body>
        ...
        <a href="/inicio2/{{ $id }}"><img src="https://cdn.pixabay.com/photo/2013/07/13/01/22/vegetables-155616_960_720.png" alt="" width="90" height="60" class="d-inline-block align-top me-1"></a>
            ...
            <div class="navbar-nav position-absolute end-0">
                ...
                <a href="/usuarios/{{ $id }}"><img src="https://image.flaticon.com/icons/png/512/50/50050.png" alt="Perfil" width="30" height="30" class="d-inline-block align-bottom"></a>
                &nbsp &nbsp &nbsp
            </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm margen2">
                    ...
                    <h2>Precio: {{ $boleta->precioTotal }}</h2>
